...
import numpy as np
from src.diffusion import r3_diffuser, so3_diffuser
from scipy.spatial.transform import Rotation
from src.openfold.utils import rigid_utils as ru
from src.diffusion import utils as du
import torch
import logging
...
class SE3Diffuser:
    """SDE diffuser class for rigid motions."""
    def __init__(self, diffuse_rot, so3_diffuser, diffuse_trans, r3_diffuser):
        """
        Args:
        ...
        self._diffuse_rot = diffuse_rot
        self._so3_diffuser = so3_diffuser

        self._diffuse_trans = diffuse_trans
        self._r3_diffuser = r3_diffuser
