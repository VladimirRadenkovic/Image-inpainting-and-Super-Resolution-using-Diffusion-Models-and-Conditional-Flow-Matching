...
import dataclasses
from src.diffusion import chemical_utils
from src.diffusion import  residue_constants
from src.diffusion import protein
from src.diffusion import so3_utils
...
def parse_pdb_lines(lines):
    ...
    for l in lines:
        ...
        for i_atm, tgtatm in enumerate(chemical_utils.aa2long[chemical_utils.aa2num[aa]]):
            if tgtatm == atom:
